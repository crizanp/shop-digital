...
const PackageCard = ({ 
  ...
  return (
    <div className="bg-white text-gray-900 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-200 flex flex-col h-full group hover:border-purple-400">
      {/* Featured Badge */}
      {featured && (
