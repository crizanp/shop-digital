...
function generatePDFHTML(packageData, quantity, selectedOptions, totalPrice, currencyInfo) {
  ...
  return `
    <div style="font-family: 'Segoe UI', Arial, sans-serif; color: #1f2937; line-height: 1.6;">
      <!-- Header with Logo, Title, and Date in One Line -->
      <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); color: white; padding: 30px;">
        <div style="display: flex; justify-content: space-between; align-items: center; gap: 20px;">
          <!-- Left: Logo -->
          <div style="flex: 0 0 auto;">
            <img src="/images/logo_white.png" style="max-width: 100px; height: auto;" alt="Foxbeep Logo" />
          </div>
          ...
          <!-- Right: Date & Time -->
          <div style="flex: 0 0 auto; text-align: right; font-size: 10px;">
